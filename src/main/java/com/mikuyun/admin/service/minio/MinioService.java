package com.mikuyun.admin.service.minio;
...
public class MinioService {
     ...
     */
    @SneakyThrows
    public ObjectWriteResponse uploadImageFile(MultipartFile file, String objectName, String contentType) {
        try (InputStream inputStream = file.getInputStream(); ByteArrayInputStream byteArrayInputStream = compressFile(inputStream)) {
            return minioClient.putObject(
                    PutObjectArgs.builder()
                            .bucket(bucketName)
                            .object(objectName)
    ...
    public String getPreSignedObjectUrl(String objectName, Integer expires) {
        GetPresignedObjectUrlArgs args = GetPresignedObjectUrlArgs.builder()
                .expiry(expires).bucket(bucketName)
                .object(objectName)
                .method(Method.GET)
                .build();
     ...
     */
    @SneakyThrows
    private ByteArrayInputStream compressFile(InputStream inputStream) {
