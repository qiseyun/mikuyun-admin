...
public class WebSocketServer {
    ...
    public void onOpen(Session session, @PathParam(value = "satoken") String satoken) {
        ...
        UserInfo admin = SatokenUserUtils.getUserInfoByToken(satoken);
        ...
        WebSocketManager.sentToAllUser("管理员" + admin.getRealName() + "已上线");
    ...
    public void onClose(@PathParam(value = "satoken") String satoken) {
        ...
        UserInfo admin = SatokenUserUtils.getUserInfoByToken(satoken);
        WebSocketManager.sentToAllUser("管理员" + admin.getRealName() + "已下线");
